...
const file_token_proto_rawDesc = "" +
	...
	"\rValidateToken\x12\x1b.token.ValidateTokenRequest\x1a\x1c.token.ValidateTokenResponseB\bZ\x06./authb\x06proto3"
...
var file_token_proto_depIdxs = []int32{
	0, // 0: token.Token.GenerateToken:input_type -> token.GenerateTokenRequest
	2, // 1: token.Token.ValidateToken:input_type -> token.ValidateTokenRequest
	1, // 2: token.Token.GenerateToken:output_type -> token.GenerateTokenResponse
	3, // 3: token.Token.ValidateToken:output_type -> token.ValidateTokenResponse
